...
//  Shared
//
//  Created by Michele Manniello on 29/07/21.
//
    ...
    var body: some View{
        ZStack{
            ...
            ZStack{
                ...
                RoundedRectangle(cornerRadius: 3)
                    .fill(.linearGradient(.init(colors: getGradient()),
                                          startPoint: .leading,
                                          endPoint: .trailing))
                    .frame(width: 180)
                    .frame(maxWidth: .infinity, alignment: .leading)
                RoundedRectangle(cornerRadius: 3)
                    .fill(.linearGradient(.init(colors: getGradient().reversed()),
                                          startPoint: .leading,
                                          endPoint: .trailing))
                    .frame(width: 180)
            ...
            .scaleEffect(0.7)
//            Bottom Landind View...
//            For taht we need custom corner...
...
//            rotating in 3D axis......
        ...
        .overlay(
            ...
            //                Applyng Shadow effect...
            
            //                To get exact shadow on both sides...
            //                applyng clear colors in between...
    ...
    func getGradient()-> [Color]{
        //        Shifiting More...
        let colors = [Color("Gray2"),Color("Gray1").opacity(0.7),Color("Gray2"),
                      Color("Gray2"),Color("Gray2"),Color("Gray2")]
        return colors
    }
}
